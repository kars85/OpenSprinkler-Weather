...
> Tracks the firmware-side work implied by the OpenSprinkler-Weather contract. **Filed on `kars85/OpenSprinkler-Firmware`** ([#2](https://github.com/kars85/OpenSprinkler-Firmware/issues/2), [#3](https://github.com/kars85/OpenSprinkler-Firmware/issues/3), [#4](https://github.com/kars85/OpenSprinkler-Firmware/issues/4)) and mirrored here (producer repo, next to the contract spec). Source of truth: [`firmware-integration-requirements.md`](firmware-integration-requirements.md).

---

## FW-1 (P1) — Adopt the `/v1` JSON weather API (non-AVR) behind a `WeatherContract` seam
**Filed:** [OpenSprinkler-Firmware#2](https://github.com/kars85/OpenSprinkler-Firmware/issues/2)
...
**Filed:** [OpenSprinkler-Firmware#3](https://github.com/kars85/OpenSprinkler-Firmware/issues/3)
...
**Filed:** [OpenSprinkler-Firmware#4](https://github.com/kars85/OpenSprinkler-Firmware/issues/4)
...
4. **Cross-repo work is tracked as firmware-repo issues** ([#2](https://github.com/kars85/OpenSprinkler-Firmware/issues/2)/[#3](https://github.com/kars85/OpenSprinkler-Firmware/issues/3)/[#4](https://github.com/kars85/OpenSprinkler-Firmware/issues/4)) and mirrored here next to the contract spec.
